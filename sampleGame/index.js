...
var sampleGame = {
    ...
    artifacts : {
        ...
        magnet : {name : 'magnet', description : 'a magnet', location : {"type" : "Point", "coordinates" : [34.8022964, 32.1201244]}, body : 'The magnet can pick up heavy pieces of iron.', icon: 'magnet.icon.jpg', assets : []}
    }
};
