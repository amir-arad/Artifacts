...
module.exports = function(app, config, passport) {
    ...
    app.put('/games/:gameId', auth.storyteller.authorize, games.update);
    ...
    app.post('/games/:gameId/players', auth.storyteller.authorize, players.create);
    app.get('/games/:gameId/players/:playerId', auth.storyteller.authorize, players.show);
    app.put('/games/:gameId/players/:playerId', auth.storyteller.authorize, players.update);
    app.del('/games/:gameId/players/:playerId', auth.storyteller.authorize, players.destroy);


    app.post('/games/:gameId/players/:playerId/login', auth.player.authenticate, silentOk);
    ...
    app.post('/games/:gameId/artifacts', auth.storyteller.authorize, artifacts.create);
    app.get('/games/:gameId/artifacts/:artifactId', auth.player.authorize, artifacts.show);
    app.put('/games/:gameId/artifacts/:artifactId', auth.storyteller.authorize, artifacts.update);
    ...
    app.put('/games/:gameId/assets/:assetId', auth.storyteller.authorize, assets.update);
    ...
    app.put('/games/:gameId/artifacts/:artifactId/assets/:assetId', auth.storyteller.authorize, assets.update);
